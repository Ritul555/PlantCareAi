...
<head>
  ...
  <title>PlantCare AI ΓÇö Scan. Detect. Protect.</title>
...
<body>
    ...
    <div class="hero-container">
      <div class="navbar-inner">
        ...
        <a href="#home" class="brand-logo" onclick="navigateTo('home')">
          <div class="brand-icon-box">≡ƒî┐</div>
    ...
    <div class="mobile-nav-panel" id="mobileNavPanel">
      <div class="mobile-nav-content">
        ...
        <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--card-border);">
          <div style="font-size: 13px; color: var(--primary-light); margin-bottom: 6px;">≡ƒôº ritul.gautam24@gmail.com</div>
          <div style="font-size: 13px; color: var(--text-muted); margin-bottom: 6px;">≡ƒôì India</div>
    ...
    <div class="hero-container">
      ...
      <div class="box-grid">
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒö¼</div>
        ...
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒôè</div>
        ...
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒ¬┤</div>
      ...
      <div class="scanner-workspace-grid">
        ...
        <div class="feature-box" id="resultContainer">
          <div id="resultEmpty" style="text-align: center; padding: 60px 20px; color: var(--text-dim);">
            <div style="font-size: 42px; margin-bottom: 12px; opacity: 0.4;">≡ƒî▒</div>
          ...
          <div id="resultCard" style="display: none;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 18px; border-bottom: 1px solid var(--card-border); padding-bottom: 16px;">
              <div>
                <div style="font-size: 11px; text-transform: uppercase; color: var(--primary-light); font-weight: 700; letter-spacing: 0.08em; margin-bottom: 2px;">≡ƒî┐ Plant Name</div>
              ...
              <div style="text-align: right;">
                <div style="font-size: 11px; text-transform: uppercase; color: var(--text-dim); font-weight: 700; margin-bottom: 2px;">≡ƒôè Confidence</div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 18px;">
              <div style="background: rgba(16, 185, 129, 0.12); border: 1px solid rgba(52, 211, 153, 0.3); border-radius: var(--radius-md); padding: 12px 14px;">
                <div style="font-size: 11px; text-transform: uppercase; color: var(--primary-light); font-weight: 700;">≡ƒ⌐║ Health Status</div>
              ...
              <div style="background: rgba(255, 255, 255, 0.04); border: 1px solid var(--card-border); border-radius: var(--radius-md); padding: 12px 14px;">
                <div style="font-size: 11px; text-transform: uppercase; color: var(--text-muted); font-weight: 700;">≡ƒªá Disease</div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(130px, 1fr)); gap: 10px; margin-bottom: 18px;">
              <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--card-border); border-radius: var(--radius-sm); padding: 10px 12px;">
                <div style="font-size: 10px; text-transform: uppercase; color: var(--text-dim); font-weight: 700;">≡ƒÆº Water</div>
                <div id="resWater" style="font-size: 13px; font-weight: 600; color: #fff; margin-top: 2px;">Every 5ΓÇô7 Days</div>
              </div>
              <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--card-border); border-radius: var(--radius-sm); padding: 10px 12px;">
                <div style="font-size: 10px; text-transform: uppercase; color: var(--text-dim); font-weight: 700;">ΓÿÇ∩╕Å Sunlight</div>
                <div id="resLight" style="font-size: 13px; font-weight: 600; color: #fff; margin-top: 2px;">Bright Indirect Light</div>
              </div>
              <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--card-border); border-radius: var(--radius-sm); padding: 10px 12px;">
                <div style="font-size: 10px; text-transform: uppercase; color: var(--text-dim); font-weight: 700;">≡ƒîí Temperature</div>
                <div id="resTemp" style="font-size: 13px; font-weight: 600; color: #fff; margin-top: 2px;">20ΓÇô28┬░C</div>
              </div>
              <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--card-border); border-radius: var(--radius-sm); padding: 10px 12px;">
                <div style="font-size: 10px; text-transform: uppercase; color: var(--text-dim); font-weight: 700;">≡ƒî▒ Soil</div>
                <div id="resSoil" style="font-size: 13px; font-weight: 600; color: #fff; margin-top: 2px;">Well-draining Potting Mix</div>
              </div>
              <div style="background: rgba(255,255,255,0.02); border: 1px solid var(--card-border); border-radius: var(--radius-sm); padding: 10px 12px;">
                <div style="font-size: 10px; text-transform: uppercase; color: var(--accent-pink); font-weight: 700;">≡ƒôà Next Watering</div>
            ...
            <div style="background: rgba(0,0,0,0.35); border: 1px solid var(--card-border); border-radius: var(--radius-md); padding: 16px; margin-bottom: 14px;">
              <div style="margin-bottom: 10px;">
                <div style="font-size: 11px; text-transform: uppercase; color: var(--primary-light); font-weight: 700;">≡ƒÆè Treatment</div>
                <div id="resTreatment" style="font-size: 13px; color: rgba(255,255,255,0.9); margin-top: 2px;">No treatment required</div>
              </div>
              <div>
                <div style="font-size: 11px; text-transform: uppercase; color: #fbbf24; font-weight: 700;">≡ƒ¢í Prevention</div>
            ...
            <div style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.12) 0%, rgba(245, 152, 242, 0.08) 100%); border: 1px solid rgba(52, 211, 153, 0.3); border-radius: var(--radius-md); padding: 14px 16px;">
              <div style="font-size: 11px; text-transform: uppercase; color: var(--accent-pink); font-weight: 700; letter-spacing: 0.05em;">≡ƒôê AI Recommendation</div>
  ...
  <section class="page-section" id="section-services">
    <div class="hero-container">
      ...
      <div class="box-grid">
        <!-- Service 1 -->
        <div class="feature-box">
          <div class="feature-box-icon">ΓÜí</div>
        ...
        <!-- Service 2 -->
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒî┐</div>
        ...
        <!-- Service 4 -->
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒºá</div>
        ...
        <!-- Service 5 -->
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒöî</div>
        ...
        <!-- Service 6 -->
        <div class="feature-box">
          <div class="feature-box-icon">≡ƒôª</div>
          <h3>Batch Identification</h3>
          <p>Want to identify multiple images at once? Whether you're a student, hobbyist or have a collection of images to identify, our Batch Identification feature simplifies bulk processingΓÇöno complicated setup needed.</p>
  ...
  <section class="page-section" id="section-about">
    <div class="hero-container">
      ...
      <div style="margin-top: 40px;">
        <h3 style="font-size: 24px; font-weight: 700; margin-bottom: 8px;">≡ƒî┐ What We Offer</h3>
        ...
        <div class="offerings-list">
          <div class="offering-item">
            <span class="offering-item-icon">Γ£ô</span>
      ...
      <div class="feature-box" style="margin-top: 40px; border-left: 4px solid var(--accent-pink);">
        <h3 style="font-size: 22px; margin-bottom: 10px;">≡ƒÜÇ Our Vision</h3>
        ...
        <div style="font-weight: 700; color: var(--primary-light); margin-top: 14px; font-size: 16px;">
          PlantCare AI ΓÇö Scan. Detect. Protect.
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="contact-grid">
        ...
        <div class="contact-card">
          ...
          <div class="contact-info-row">
            <div class="contact-info-icon">≡ƒôº</div>
            <div>
          ...
          <div class="contact-info-row">
            <div class="contact-info-icon">≡ƒôì</div>
            <div>
          ...
          <div class="contact-info-row">
            <div class="contact-info-icon">≡ƒîÉ</div>
            <div>
          ...
          <div class="contact-info-row">
            <div class="contact-info-icon">≡ƒÆ╝</div>
            <div>
        ...
        <div class="contact-card">
          ...
          <div class="contact-reasons-list">
            <div class="reason-pill">≡ƒ¢á Technical Support</div>
            <div class="reason-pill">≡ƒî┐ Plant Diagnosis Assistance</div>
            <div class="reason-pill">≡ƒÆí Feature Requests & Suggestions</div>
            <div class="reason-pill">≡ƒñ¥ Collaboration Opportunities</div>
            <div class="reason-pill">≡ƒô⌐ General Inquiries</div>
          </div>
          ...
          <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--card-border);">
            ...
            <div style="margin-top: 12px; font-weight: 700; font-size: 13px; color: #fff;">
              ≡ƒî▒ PlantCare AI ΓÇö Helping Plants Thrive with the Power of Artificial Intelligence.
            </div>
          </div>
        </div>
      </div>
  ...
  <footer>
    <div class="hero-container">
      <p style="font-weight: 600; color: rgba(255,255,255,0.7); margin-bottom: 6px;">PlantCare AI ΓÇö Scan. Detect. Protect.</p>
      <p style="font-size: 12px;">Contact: <a href="mailto:ritul.gautam24@gmail.com" style="color: var(--primary-light); text-decoration: none;">ritul.gautam24@gmail.com</a> ΓÇó India</p>
    </div>
  </footer>
  ...
  <script>
    ...
    function renderResults(d) {
      ...
      document.getElementById('resWater').textContent = (typeof d.water === 'string' ? d.water : (d.water?.recommendation || d.water_requirement || 'Every 5ΓÇô7 Days'));
      ...
      document.getElementById('resTemp').textContent = d.temperature || '20ΓÇô28┬░C';
